...
function Gallery() {
  ...
  return (
    <SiteLayout>
      <PageHero eyebrow="Dokumentasi" title="Momen kebaikan" description="Jendela menuju lapangan — senyum, haru, dan harapan." />
      <section className="container-x py-20">
        <Breadcrumbs className="mb-8" items={[{ label: "Dokumentasi" }]} />
