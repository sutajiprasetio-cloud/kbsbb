...
export function EmptyState({ title = "Nothing here yet", description = "Content will appear here as soon as it is published.", className = "" }: { title?: string; description?: string; className?: string }) {
  return (
